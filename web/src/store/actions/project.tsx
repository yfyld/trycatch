...
export const doUpdateProjectMemberRequest = createAction(ACTIONTYPE.UPDATE_PROJECT_MEMBER_REQUEST, resolve => (data: ProjectMemberUpdate) => resolve(data))
...
export const doAddSourcemapRequest = createAction(ACTIONTYPE.ADD_SOURCEMAP_REQUEST, resolve => (form: WrappedFormUtils<SourcemapAdd>) => resolve(form))
...
export const doOperateSourcemapRequest = createAction(ACTIONTYPE.OPERATE_SOURCEMAP_REQUEST, resolve => (data: SourcemapOperate) => resolve(data))
