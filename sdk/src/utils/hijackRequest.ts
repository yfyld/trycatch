import { getFlag, setFlag, class2Type } from './util';
...
export function hijackXMLHttpRequest() {
    ...
    XMLHttpRequest.prototype.send = function() {
        ...
        this.addEventListener('loadend', function() {
            ...
            if (class2Type(data) === '[object String]' || class2Type(data) === '[object object]') {
                this['reqData'] = data;
            }
            this.elapsedTime = Date.now() - this.sTime;
...
export function hijackFetch() {
    ...
    window.fetch = function(url: string, config: RequestInit): Promise<Response> {
        ...
        return oldFetch.apply(this, arguments).then(function(response: Response) {
            ...
            if (data.responseText) {
                data.responseText instanceof Promise && data.responseText.then(function(text: string) {
